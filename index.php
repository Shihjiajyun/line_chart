                        ...
                        <div class="card text-white status-<?php echo htmlspecialchars($row['status']); ?> shadow-sm border-0">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    ...
                                    <a href="number.php?id=<?php echo htmlspecialchars($row['id']); ?>"
                                        class="btn btn-light">
                                        查看詳情
                                    </a>
                                </div>
                ...
                <div class="modal-body">
                    <form id="edit-card-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit-card-subtitle" placeholder="輸入自定義子標題" required>
                        </div>
                        <!-- Card Text Field -->
                        <div class="mb-3">
                ...
                <div class="modal-body">
                    <form id="add-card-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="add-card-subtitle" placeholder="輸入自定義子標題" required>
                        </div>
                        <!-- Card Text Field -->
                        <div class="mb-3">
